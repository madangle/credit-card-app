    ...
    validateField(fieldName, value) {
        ...
        switch(fieldName) {
            case 'cardName':
                ...
                fieldValidationErrors.cardName = cardNameValid ? '' : ' should contain minimum 3 letters';
                break;
            case 'cardNumber':
                cardNumberValid = this.validateLuhn(value);
                fieldValidationErrors.cardNumber = cardNumberValid ? '': ' is invalid. Please provide a valid number';
                break;
            case 'cardLimit':
                cardLimitValid = (typeof parseInt(value) == "number");
                fieldValidationErrors.cardLimit = cardLimitValid ? '' : ' is  should be a valid number';
                break;
